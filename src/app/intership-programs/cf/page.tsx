...
import { cfSyllabus, techImagesLinks, intershipDetails } from "@/lib/constant";
...
export default function ProgramDetail() {
  const intershipDetail = intershipDetails.filter(
    (intershipDetail) => intershipDetail.intershipNo === "cf"
  );
  return (
    <section className="md:mt-20 w-full space-y-10">
                ...
                <p className="lg:space-y-5 space-y-5 px-2">
                  ...
                  <p className="lg:text-3xl md:text-2xl  text-3xl font-helveticaNowDisplayBold">
                    ...
                    <span className="text-emerald-500 font-helveticaNowDisplayExtraBold">
                      ₹ {intershipDetail[0].droppedPrice}*
                    </span>
                  </p>
                  ...
                  <p className="lg:text-lg text-sm font-helveticaNowDisplayRegular">
                    {intershipDetail[0].description}
                  </p>
                </p>
              </p>
              <div className=" rounded-xl flex justify-end bg-zinc-900 ">
                <Image
                  src={intershipDetail[0].imageSrc}
                  alt={intershipDetail[0].imageAlt}
                  layout="reponsive"
                  width={600}
                  height={600}
      ...
      <section>
        <MaxWidthWrapper>
          <ProgramsBenefits data={intershipDetail[0].benefits} />
        </MaxWidthWrapper>
      </section>
